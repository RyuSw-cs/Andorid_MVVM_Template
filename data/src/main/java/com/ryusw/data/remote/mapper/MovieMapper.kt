...
import com.ryusw.domain.entitiy.movie.Genre
import com.ryusw.domain.entitiy.movie.Movie
import com.ryusw.domain.entitiy.movie.ProductionCompany
import com.ryusw.domain.entitiy.movie.ProductionCountry
import com.ryusw.domain.entitiy.movie.SpokenLanguage
...
internal fun ResponseMovieDetail.toDomain(): Movie {
    return Movie(
        ...
        originalCountry = originCountry.toList(),
